// Package version carries Bulls and Bears' version number.
//
...
// time instead:
//
//	go build -ldflags "-X github.com/chinmay28/bulls-and-bears/server/internal/version.Patch=$(git rev-list --count HEAD)"
//
